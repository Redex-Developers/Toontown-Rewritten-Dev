...
import DistributedSuitBase, SuitDNA
...
class DistributedElectionEvent(DistributedObject, FSM):
    ...
    def __init__(self, cr):
        ...
        self.counterLeft.setBlend(frameBlend = base.wantSmoothAnims)
        ...
        self.counterRight.setBlend(frameBlend = base.wantSmoothAnims)
        ...
        self.slappyStand.setBlend(frameBlend = base.wantSmoothAnims)
    ...
    def enterBegin(self, offset):
        ...
        musicIntro = base.loader.loadMusic(ElectionGlobals.IntroMusic)
        self.slappyStand.loop('watch-idle')
        self.ignore('enter' + self.pieCollision.node().getName())
    ...
    def enterVoteBuildup(self, offset):
        ...
        self.finishedBegin = True
        self.catchUp()
        musicAnnouncement = base.loader.loadMusic(ElectionGlobals.AnnouncementMusic)
    ...
    def enterWinnerAnnounce(self, offset):
        ...
        self.finishedBegin = True
        self.catchUp()
        musicVictory = base.loader.loadMusic(ElectionGlobals.VictoryMusic)
    ...
    def enterCogLanding(self, offset):
        ...
        self.finishedBegin = True
        self.catchUp()
        musicSad = base.loader.loadMusic(ElectionGlobals.SadMusic)
    ...
    def enterWrapUp(self, offset):
        ...
        musicCredits = base.loader.loadMusic(ElectionGlobals.CreditsMusic)
