...
class OptionsTabPage(DirectFrame):
    ...
    def __init__(self, parent = aspect2d):
        ...
        DirectFrame.__init__(self, parent = self._parent_aspect2d, relief = None, pos = (0.0, 0.0, 0.0), scale = (1.0, 1.0, 1.0))
        self.load()
        return

    def destroy(self):
        self._parent_aspect2d = None
    ...
    def __handleExitShowWithConfirm(self):
        ...
        self.confirm.show()
        self._parent_aspect2d.doneStatus = {'mode': 'exit',
         'exitTo': 'closeShard'}
    ...
    def __handleConfirm(self):
        ...
        if status == 'ok':
            ...
            messenger.send(self._parent_aspect2d.doneEvent)
