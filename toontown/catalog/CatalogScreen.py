    ...
    def setClarabelleChat(self, str, timeout = 6, type = None):
        ...
        if type == 'greeting':
            if not self.clarabelleGreetingSfx:
                clarabelleGreeting1 = base.loader.loadSfx('phase_5.5/audio/dial/clarabelle_ah_1.ogg')
                clarabelleGreeting2 = base.loader.loadSfx('phase_5.5/audio/dial/clarabelle_ah_2.ogg')
            ...
            if not self.clarabelleGoodbyeSfx:
                clarabelleGoodbye1 = base.loader.loadSfx('phase_5.5/audio/dial/clarabelle_wa_2.ogg')
                clarabelleGoodbye2 = base.loader.loadSfx('phase_5.5/audio/dial/clarabelle_wa_3.ogg')
                clarabelleGoodbye3 = base.loader.loadSfx('phase_5.5/audio/dial/clarabelle_wa_4.ogg')
            ...
            if not self.clarabelleErrorSfx:
                clarabelleError1 = base.loader.loadSfx('phase_5.5/audio/dial/clarabelle_ah_2.ogg')
            ...
            if not self.clarabelleChatterSfx:
                clarabelleChatter1 = base.loader.loadSfx('phase_5.5/audio/dial/clarabelle_ah_2.ogg')
                clarabelleChatter2 = base.loader.loadSfx('phase_5.5/audio/dial/clarabelle_gen_2.ogg')
